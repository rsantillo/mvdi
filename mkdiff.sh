...
if [[ $REDEFINE -eq 1 ]]; then
    ...
    ssh root@$dom0 "virt-customize -a /var/lib/libvirt/images/diff.qcow2 --run-command  'cat /dev/null > /etc/sysconfig/network-scripts/ifcfg-eth0 ; echo \"DEVICE=eth0\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"TYPE=Ethernet\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"ONBOOT=yes\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"BOOTPROTO=none\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"NETWORKING_IPV6=no\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"IPV6_AUTOCONF=no\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"DEFROUTE=no\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"NETMASK=255.255.255.0\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; echo \"IPADDR=$diff\" >> /etc/sysconfig/network-scripts/ifcfg-eth0; chcon system_u:object_r:net_conf_t:s0 /etc/sysconfig/network-scripts/ifcfg-eth0'"
